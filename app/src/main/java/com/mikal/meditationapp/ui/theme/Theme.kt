...
package com.mikal.meditationapp.ui.theme
...
private val LightColorPalette = MeditationColors(
    brand = Shadow5,
...
fun MeditationTheme(
    ...
    ProvideMeditationColors(colors) {
        MaterialTheme(
...
object MeditationTheme {
    val colors: MeditationColors
        @Composable
        get() = LocalMeditationColors
            .current
}
...
fun ProvideMeditationColors(
    ...
    CompositionLocalProvider(LocalMeditationColors provides colorPalette, content = content)
}
